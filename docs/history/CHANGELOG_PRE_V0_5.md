# CAPT Solo — Historical Pre-v0.5 Changelog Snapshot

**Status:** Historical evidence only. Superseded by the current root
`CHANGELOG.md`. Numerical verification claims below apply only to the historical
states that originally recorded them.
