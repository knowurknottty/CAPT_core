...
The public runtime currently includes the v0.5.0 verification substrate: the
six-pillar architecture (Identity & Scope, Evidence, Verification, Context,
Transactions, Governance) with v0.4.1 hardening work incorporated.
...
- semantic and vector search adapter seam
