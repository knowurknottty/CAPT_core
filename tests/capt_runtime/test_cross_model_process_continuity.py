...
def test_cross_model_process_restart_continuity():
    ...
    try:
        ...
        # --- Start Mock Provider HTTP Servers for Model A and Model B ---
        ...
        # --- Phase 2: Launch Process 2 against SAME ledger with Model B ---
        ...
        # Check that Model A state is preserved durably
        st_a = client2.get_state("driverrun-dr-cross-model-a")
        assert st_a["state"] == "completed"

        # Dispatch Turn 2 with distinct Model B
